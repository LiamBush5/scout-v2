...
function Radar() {
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
      <div className="relative w-[800px] h-[800px] opacity-[0.15]">
        {/* Radar circles */}
        <div className="absolute inset-0 rounded-full border border-primary/30" />
        <div className="absolute inset-[100px] rounded-full border border-primary/25" />
        <div className="absolute inset-[200px] rounded-full border border-primary/20" />
        <div className="absolute inset-[300px] rounded-full border border-primary/15" />
        ...
        {/* Scanning beam */}
        <div 
          className="absolute top-1/2 left-1/2 w-1/2 h-1 origin-left animate-radar-scan"
          style={{
        ...
        {/* Radar trail/fade effect */}
        <div 
          className="absolute top-1/2 left-1/2 w-1/2 h-full origin-left animate-radar-scan"
          style={{
            background: 'conic-gradient(from 0deg, hsl(var(--primary) / 0.3) 0deg, transparent 60deg)',
            clipPath: 'polygon(0 50%, 100% 0, 100% 100%)',
          }}
        />
        
        {/* Blips - detected incidents */}
        <div 
          className="absolute w-2 h-2 rounded-full bg-primary animate-radar-blip"
          style={{ top: '25%', left: '60%' }}
        />
        <div 
          className="absolute w-2 h-2 rounded-full bg-primary animate-radar-blip"
          style={{ top: '35%', left: '75%', animationDelay: '1s' }}
        />
        <div 
          className="absolute w-2 h-2 rounded-full bg-primary animate-radar-blip"
          style={{ top: '70%', left: '65%', animationDelay: '2s' }}
        />
        <div 
          className="absolute w-1.5 h-1.5 rounded-full bg-primary animate-radar-blip"
          style={{ top: '55%', left: '80%', animationDelay: '0.5s' }}
        />
        <div 
          className="absolute w-1.5 h-1.5 rounded-full bg-primary animate-radar-blip"
          style={{ top: '20%', left: '45%', animationDelay: '1.5s' }}
        />
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        {/* Gradient overlay to fade radar */}
