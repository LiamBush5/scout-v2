...
export function DatadogIcon({ className }: IconProps) {
  return (
    <Image
      src="https://imgix.datadoghq.com/img/dd_logo_70x75.png"
      alt="Datadog"
      width={20}
      height={20}
...
// Integration display config with colors
export const integrationConfig = {
  ...
  github: {
    name: 'GitHub',
    icon: GitHubIcon,
    bgColor: 'bg-[#1a1a1a] border border-border/50',
    description: 'Deployments & Code',
  },
  slack: {
    name: 'Slack',
    icon: SlackIcon,
